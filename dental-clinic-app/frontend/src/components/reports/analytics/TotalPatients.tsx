  ...
  return (
    <div className="bg-white border border-surface-200 rounded-lg p-4 flex items-center gap-4">
      ...
      <div className="flex-1">
        ...
        <div className="font-display text-2xl font-semibold tracking-tight text-surface-900 tabular-nums">{total}</div>
        <div className="flex items-center text-xs text-success-700 tabular-nums">
