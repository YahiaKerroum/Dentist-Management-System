            ...
            <div className="w-80 bg-white rounded-xl shadow-sm border border-surface-200">
                ...
                <div className="p-4 space-y-4">
                    ...
                    <div>
                        ...
                        <div className="text-surface-900">{date}</div>
                    </div>
                    ...
                    <div>
                        ...
                        {appointment.patient?.phone && (
                            <div className="text-sm text-surface-500 mt-1">{appointment.patient.phone}</div>
                        )}
                        {appointment.patient?.email && (
                            <div className="text-sm text-surface-500">{appointment.patient.email}</div>
                        )}
                    </div>
                    ...
                    <div>
                        ...
                        <select
                            ...
                            className="w-full px-3 py-2 rounded-lg border border-surface-200 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                    ...
                    {appointment.notes && (
                        <>
                            <div>
                                ...
                                <div className="text-surface-700 bg-surface-50 rounded-lg p-3 text-sm">
                                    {appointment.notes}
                                </div>
                            </div>
                        </>
